...
Most people simply don't have the time to pour over books and readings, so they allow financial advisors to manage their funds via 401k retirement accounts or various highly regarded indexes and ETFs like the S&P500. These investments are essentially large bundles that are tied to the overall market performance.
...
Understanding incentives is the next most difficult challenge behind picking stocks. You need to understand why people do things. That is a tricky and disappointing process and it as complicated as advanced multivariable calculus. But once you have a solid grasp of that, you know why organizations like Pinterest can exist happily along organizations like Instagram and Amazon.
